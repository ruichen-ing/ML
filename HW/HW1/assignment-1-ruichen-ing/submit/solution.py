...
q_3_2 = """
        The model can identify 'tsu' characters in the forms that are not so complicated, like '𠃌' or '⊐'. When there are multiple strokes 
        in the character, like '传', it tends to misclassify. The 2.1 and 2.2 show the model with C=1e-6 is underfitting and has not good 
